using StoreManager2.Api.Services;
using StoreManager2.Application.DTOs.Settings;
using StoreManager2.Application.Interfaces;
...
using StoreManager2.Infrastructure.Identity.Services;
using StoreManager2.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\StoreManager2.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
